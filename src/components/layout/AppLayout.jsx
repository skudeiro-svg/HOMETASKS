...
const ROLE_COLORS = {
  ...
  maestro:  'bg-gold-100 text-yellow-700',
...
export default function AppLayout() {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-4 border-b border-navy-600">
        ...
        <div className="mt-2 flex items-center gap-2">
          ...
          <span className="badge bg-gold-100 text-yellow-700">⭐ {profile?.points || 0} pts</span>
        </div>
      </div>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all ${
                isActive
                  ? 'bg-gold-400 text-navy-800 font-semibold'
      ...
      <div className="px-3 py-4 border-t border-navy-600">
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm text-gray-400 hover:bg-navy-600 hover:text-white transition-all"
        >
  ...
  return (
    <div className="flex min-h-screen bg-stone-50">
      ...
      {/* Mobile top bar */}
      <div className="lg:hidden fixed top-0 inset-x-0 z-30 h-14 bg-navy-800 flex items-center px-4 gap-3">
